...
On va terminer le point traité au cours précédent par un exemple un peu plus conséquent d'une preuve manuelle en logique des prédicats avant d'introduire l'algorithme permettant d'effectuer des preuves de manière automatisée.
...
\subsection{Propriétés de cet algorithme}
\begin{itemize}
...
\end{itemize}
\subsection{Transformation de la formule de base vers la forme prénexe}
...
\end{enumerate}
\subsubsection*{Exemple d'une transformation en forme prénexe}
\begin{enumerate}
